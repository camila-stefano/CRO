function hideSlidesWhenReady(slides = []) {
  ...
  const slider = document.querySelector(".thumbnails-container .slick-slider");
  ...
  slides.forEach((slide) => {
    ...
    document
      .querySelectorAll(`.product-primary-image [data-slick-index='${slide}']`)
      .forEach((element) => {
...
function observeProductImageContainer() {
  ...
  if (!targetNode) {
    console.log("$$$ $$$ .product-image-container no encontrado, esperando...");
